...
public class Cisotrxns {
	...
	@JoinColumn(name = "serno", nullable = false)
	private Ctransactions ctransactions;
	...
	private Long authtrxntype;
	private Long authserno;
	private Long authpartitionkey;
	private Long authreasoncode;
	...
	public Ctransactions getCtransactions() {
		return ctransactions;
	}

	public Long getPsvatamount() {
		return psvatamount;
	}

	public Long getAuthtrxntype() {
		return authtrxntype;
	}

	public Long getAuthserno() {
		return authserno;
	}

	public Long getAuthreasoncode() {
		return authreasoncode;
	}

	public void setCtransactions(Ctransactions ctransactions) {
		this.ctransactions = ctransactions;
	}

	public void setPsvatamount(Long psvatamount) {
		this.psvatamount = psvatamount;
	}

	public void setAuthtrxntype(Long authtrxntype) {
		this.authtrxntype = authtrxntype;
	}

	public void setAuthserno(Long authserno) {
		this.authserno = authserno;
	}

	public void setAuthreasoncode(Long authreasoncode) {
